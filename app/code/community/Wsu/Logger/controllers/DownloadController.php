...
class Wsu_Logger_DownloadController extends Mage_Downloadable_DownloadController {
    public function linkAction() {
        ...
        if ($status == Mage_Downloadable_Model_Link_Purchased_Item::LINK_STATUS_AVAILABLE && ($downloadsLeft || $linkPurchasedItem->getNumberOfDownloadsBought() == 0)) {
            ...
            try {
                ...
                Mage::helper('wsu_logger')->log($linkPurchasedItem->getLinkTitle(), $linkPurchasedItem->getLinkFile(), $linkPurchasedItem->getProductId(), $this->_getCustomerSession()->getCustomerId());
