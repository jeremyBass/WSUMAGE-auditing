 ...
 */
class Wsu_Auditing_Model_Observer_Model_Save extends Wsu_Auditing_Model_Observer_Model_Abstract {
    /**
    ...
    protected function getAction() {
        if ($this->hadIdAtBefore() // for models which call model_save_before
            ...
            return Wsu_Auditing_Helper_Data::ACTION_UPDATE;
        } else {
            return Wsu_Auditing_Helper_Data::ACTION_INSERT;
        }
    }
