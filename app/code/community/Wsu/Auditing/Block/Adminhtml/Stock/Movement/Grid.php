<?php
class Wsu_Auditing_Block_Adminhtml_Stock_Movement_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('wsu_auditing/stock_movement')->getCollection();
        if ($this->getProduct()) {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('qty', array(
            'header' => Mage::helper('wsu_auditing')->__('Quantity'),
            'align' => 'right',
            'index' => 'qty',
            'type' => 'number',
            'width' => '80px',
        ...
        $this->addColumn('movement', array(
            'header' => Mage::helper('wsu_auditing')->__('Movement'),
            'align' => 'right',
            'index' => 'movement',
            'width' => '80px',
            'filter' => false
        ...
        $this->addColumn('is_in_stock', array(
            'header' => Mage::helper('wsu_auditing')->__('In Stock'),
            'align' => 'right',
            'index' => 'is_in_stock',
            'type' => 'options',
            'options' => array(
        ...
        $this->addColumn('user', array(
            'header' => Mage::helper('wsu_auditing')->__('User'),
            'align' => 'center',
            'index' => 'user'
        ));
